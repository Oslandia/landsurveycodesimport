...
class LandSurveyFieldCodes:
    ...
    def __init__(self, iface):
        ...
        if os.path.exists(locale_path):
            ...
            ret = self.translator.load(locale_path)
            if qVersion() > '4.3.3':
        ...
        self.actions = []
        self.menu = self.tr(u'&Land Survey Codes Import')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/LandSurveyFieldCodes/icon.png'
        self.add_action(
            icon_path,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Land Survey Codes Import'),
                action)
