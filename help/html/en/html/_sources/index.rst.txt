...
+-------------------------------------------------------------+-------+------+---------+------------------+----------------------+---------+
| Square by 2 points                                          | X     | X    | X       | 2                | 0                    | Yes     |
+-------------------------------------------------------------+-------+------+---------+------------------+----------------------+---------+
| Square by 2 diagnoal points                                 | X     | X    | X       | 2                | 0                    | Yes     |
+-------------------------------------------------------------+-------+------+---------+------------------+----------------------+---------+
| Rectangle by 2 points and height [1]                        | X     | X    | X       | 2                | 1                    | Yes     |
+-------------------------------------------------------------+-------+------+---------+------------------+----------------------+---------+
| Rectangle by 3 points (3rd point = distance from 2nd point) | X     | X    | X       | 3                | 0                    | Yes     |
+-------------------------------------------------------------+-------+------+---------+------------------+----------------------+---------+
| Rectangle by 3 points (3rd point = orthogonal projection)   | X     | X    | X       | 3                | 0                    | Yes     |
+-------------------------------------------------------------+-------+------+---------+------------------+----------------------+---------+
